        ...
        <div className="Principal">
            <BrowserRouter >
                <Routes>
                    ...
                    <Route element={<ProtectedRoute isAllowed={!!user && user.permissions.includes("Juez")}/>}>
                        <Route path="/J/" element={<InicioJuez func={logout}/>} />
                        <Route path="/J/perfil" element={<PerfilJuez func={logout}/>} />
                        <Route path="/J/demandas" element={<DemandaJuez func={logout}/>} />
                    ...
                    <Route element={<ProtectedRoute isAllowed={!!user && user.permissions.includes("PN")}/>}>
                        <Route path="/P/" element={<InicioPN func={logout}/>} />
                        <Route path="/P/perfil" element={<PerfilPN func={logout}/>} />
                        <Route path="/P/demandas" element={<LlenarDemanda func={logout}/>} />
                        <Route path="/P/demandas/:id" element={<DetalleDemanda func={logout}/>} />
                    </Route>
