        ...
        <>
            ...
            <div className="Contenido">
                ...
                <div className="Seccion">
                    ...
                    formulario para realizar una demanda de alimentos, se tendrá
                    que llenar con la información necesaria y enviada por esta
                    página para poder iniciar el proceso judicial.{" "}
                    <b>*Descripción momentanea*</b>
                </div>
                ...
                <div className="SubidaPDF">
                    ...
                    <label for="subirDemanda" class="custom-subirDemanda">
                        Subir Archivo
                    </label>
                ...
                <div className="divCaptcha">
                    <div className="Captcha">
                        <input type="checkbox" id="robot" value="esrobot" /> No
                        soy un robot.
                    </div>
                </div>
